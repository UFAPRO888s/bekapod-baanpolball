    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-invert-links-hover': theme('colors.pink.400'),
          '--tw-prose-invert-underline': theme('colors.pink.400 / 0.3'),
          '--tw-prose-invert-underline-hover': theme('colors.pink.400'),
